...
// getComponents safely returns the components map from the document.
func getComponents(doc map[string]interface{}) map[string]interface{} {
	c, _ := doc["components"].(map[string]interface{})
	return c
}
